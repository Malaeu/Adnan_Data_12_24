...
pacman::p_load(
  ...
  # Additional packages for your specific analysis
  ################################################
  ...
  car,              # companion to applied regression
    glmnet,           # generalized linear models with lasso or elasticnet regularization
  randomForestSRC,
  aorsf             # random forests for survival, regression, and classification
)
